...
<table width="1000">
    ...
    <c:forEach var="lookupDTO" items="${lookupDTOS}">
        <tr align="center">
            <td width="150">
                <img src="img/${lookupDTO.img}" alt="${lookupDTO.cname}" width="120" height="70">
            </td>
            ...
            <td width="90">
                <input type="button" onclick="location.href='BookDelCon?rno=${lookupDTO.rno}'" value="예약취소">
            </td>
        </tr>
    </c:forEach>
</table>
